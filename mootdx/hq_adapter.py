...
class StdHqAdapter:
    """兼容 tdxpy TdxHq_API 接口的 opentdx 适配器，优先使用 opentdx"""
    ...
    def connect(self, ip, port, time_out=15):
        ...
        if self._backend == 'opentdx':
            ...
            return self._client.connect(str(self._ip), self._port, time_out=time_out)
    ...
    def get_security_bars(self, category, market, code, start, count):
        if self._backend == 'opentdx':
            ...
            return items
        return self._client.get_security_bars(category, market, code, start, count)

    def get_index_bars(self, category, market, code, start, count):
        if self._backend == 'opentdx':
            return self.get_security_bars(category, market, code, start, count)
        return self._client.get_index_bars(category, market, code, start, count)
    ...
    def get_security_quotes(self, all_stock=None, code=None):
        if self._backend == 'opentdx':
            ...
            for q in result:
                ...
                items.append(item)
            return items
        return self._client.get_security_quotes(all_stock, code)

    def get_security_count(self, market):
        if self._backend == 'opentdx':
            return self._client.get_count(self._convert_market(market))
        return self._client.get_security_count(market)
    ...
    def get_security_list(self, market, start):
        ...
        return self._client.get_security_list(market, start)
    ...
    def get_history_transaction_data(self, market, code, start, count, date):
        ...
        return self._client.get_history_transaction_data(market, code, start, count, date)
    ...
    def get_xdxr_info(self, market, code):
        if self._backend == 'opentdx':
            ...
            return items
        return self._client.get_xdxr_info(market, code)
    ...
    def get_finance_info(self, market, code):
        ...
        return self._client.get_finance_info(market, code)
    ...
    def get_company_info_category(self, market, code):
        ...
        return self._client.get_company_info_category(market, code)
    ...
    def get_company_info_content(self, market, code, filename, start, length):
        ...
        return self._client.get_company_info_content(market=market, code=code, filename=filename, start=start, length=length)
    ...
    def get_and_parse_block_info(self, block_file):
        ...
        return self._client.get_and_parse_block_info(block_file)

    def get_traffic_stats(self):
        if self._backend == 'opentdx':
            return None
        return self._client.get_traffic_stats()
    ...
    def get_report_file_by_size(self, filename, filesize=0, reporthook=None):
        ...
        return self._client.get_report_file_by_size(filename, filesize, reporthook)
